...
- (void)testNSStringUnsignedLongLongValue
{
    ...
    NSString *longLongMaxValue =
        [NSString stringWithFormat:@"%lu", 0x7FFFFFFFFFFFFFFF];
    XCTAssertEqual(
        [longLongMaxValue unsignedLongLongValue], 9223372036854775807);

    NSString *negativelongLongMaxValue =
        [NSString stringWithFormat:@"%lu", -0x8000000000000000];
    XCTAssertEqual(
        [negativelongLongMaxValue unsignedLongLongValue], 0x8000000000000000);

    NSString *unsignedLongLongMaxValue =
        [NSString stringWithFormat:@"%lu", 0xFFFFFFFFFFFFFFFF];
    XCTAssertEqual(
        [unsignedLongLongMaxValue unsignedLongLongValue], 0xFFFFFFFFFFFFFFFF);
}
