...
class SentryHttpTransportTests: XCTestCase {
    ...
    private class Fixture {
        ...
        init() {
            ...
            let eventEnvelope = SentryEnvelope(id: event.eventId, items: [SentryEnvelopeItem(event: event), SentryEnvelopeItem(attachment: TestData.dataAttachment, maxAttachmentSize: 5 * 1024 * 1024)!])
