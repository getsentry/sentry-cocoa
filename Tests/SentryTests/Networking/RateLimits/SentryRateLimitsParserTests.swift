...
class SentryRateLimitsParserTests: XCTestCase {
    ...
    func testOneQuotaOneCategory() {
        let expected = [
            SentryDataCategory.transaction: currentDate.date().addingTimeInterval(50)
        ]
    ...
    func testOneQuotaTwoCategories() {
        ...
        let expected = [
            SentryDataCategory.transaction: retryAfter,
            SentryDataCategory.error: retryAfter
        ]
    ...
    func testTwoQuotasMultipleCategories() {
        ...
        let expected = [
            SentryDataCategory.transaction: currentDate.date().addingTimeInterval(50),
            SentryDataCategory.error: retryAfter2700,
            SentryDataCategory.default: retryAfter2700,
            SentryDataCategory.attachment: retryAfter2700
        ]
    ...
    func testInvalidRetryAfter() {
        let expected = [SentryDataCategory.default: currentDate.date().addingTimeInterval(1)]
    ...
    func testAllCategories() {
        let expected = [SentryDataCategory.all: currentDate.date().addingTimeInterval(1_000)]
    ...
    func testOneUnknownAndOneKnownCategory() {
        let expected = [SentryDataCategory.error: currentDate.date().addingTimeInterval(2)]
    ...
    func testAllKnownCategories() {
        ...
        let expected = [
            SentryDataCategory.default: date,
            SentryDataCategory.error: date,
            SentryDataCategory.session: date,
            SentryDataCategory.transaction: date,
            SentryDataCategory.attachment: date,
            SentryDataCategory.profile: date,
            SentryDataCategory.all: date
        ]
    ...
    func testWhitespacesSpacesAreRemoved() {
        ...
        let expected = [SentryDataCategory.all: currentDate.date().addingTimeInterval(67),
                        SentryDataCategory.transaction: retryAfter10,
                        SentryDataCategory.error: retryAfter10
        ]
