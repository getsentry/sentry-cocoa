...
class SentryUIViewControllerPerformanceTrackerTests: XCTestCase {
    ...
    private func testUILifeCycle(transactionStatus: SentrySpanStatus, lifecycleEndingMethod: (SentryUIViewControllerPerformanceTracker, UIViewController, SentryPerformanceTracker, XCTestExpectation, Span) -> Void) {
        ...
        let layoutSubViewsSpan = self.getStack(tracker).last!
        ...
        let viewAppearingSpan = self.getStack(tracker).last!
    ...
    func testTimeMeasurement() {
        ...
        let layoutSubViewsSpan = getStack(tracker).last!
    ...
    func testTimeMeasurement_SkipLoadView() {
        ...
        let viewAppearingSpan = getStack(tracker).last!
        advanceTime(bySeconds: 4)
