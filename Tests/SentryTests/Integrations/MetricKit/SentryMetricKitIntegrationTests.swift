...
final class SentryMetricKitIntegrationTests: SentrySDKIntegrationTestsBase {
    ...
    func testMXCrashPayloadReceived() throws {
        ...
        Dynamic(sut).didReceiveCrashDiagnostic(MXCrashDiagnostic(), callStackTree: callStackTreePerThread, timeStampBegin: currentDate.date(), timeStampEnd: currentDate.date())
    ...
    func testCPUExceptionDiagnostic() throws {
        ...
        Dynamic(sut).didReceiveCpuExceptionDiagnostic(TestMXCPUExceptionDiagnostic(), callStackTree: callStackTreeNotPerThread, timeStampBegin: currentDate.date(), timeStampEnd: currentDate.date())
    ...
    func testDiskWriteExceptionDiagnostic() throws {
        ...
        Dynamic(sut).didReceiveDiskWriteExceptionDiagnostic(TestMXDiskWriteExceptionDiagnostic(), callStackTree: callStackTreeNotPerThread, timeStampBegin: currentDate.date(), timeStampEnd: currentDate.date())
