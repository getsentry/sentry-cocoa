...
final class SentryLogFlushIntegrationTests: XCTestCase {
    ...
    private class Fixture {
        ...
        func getSut() -> LogFlushIntegration<SentryDependencyContainer>? {
            return LogFlushIntegration(with: options, dependencies: dependencies)
        }
    }
    ...
    func testName_ReturnsCorrectName() {
        XCTAssertEqual(LogFlushIntegration<SentryDependencyContainer>.name, "SentryLogFlushIntegration")
    }
