...
class SentryCrashInstallationReporterTests: XCTestCase {
    ...
    override func setUp() {
        super.setUp()
        sut = SentryCrashInstallationReporter(inAppLogic: SentryInAppLogic(inAppIncludes: [], inAppExcludes: []), crashWrapper: TestCrashWrapper(), dispatchQueue: TestSentryDispatchQueueWrapper())
        sut.install()
