...
final class CrashSafeBatchBufferTests: XCTestCase {
    ...
    func testInit_whenValidCapacity_shouldSucceed() throws {
        // -- Act --
        let sut = try CrashSafeBatchBuffer<TestElement>(dataCapacity: 1_024 * 1_024, itemsCapacity: 100)
    ...
    func testInit_whenZeroCapacity_shouldSucceed() throws {
        // -- Act --
        let sut = try CrashSafeBatchBuffer<TestElement>(dataCapacity: 0, itemsCapacity: 0)
    ...
    func testClear_afterClear_shouldAllowNewAppends() throws {
        // -- Arrange --
        let sut = try CrashSafeBatchBuffer<TestElement>(dataCapacity: 1_024 * 1_024, itemsCapacity: 100)
        try sut.append(TestElement(id: 1))
        try sut.append(TestElement(id: 2))
    ...
    func testSize_afterClear_shouldReturnZero() throws {
        // -- Arrange --
        let sut = try CrashSafeBatchBuffer<TestElement>(dataCapacity: 1_024 * 1_024, itemsCapacity: 100)
        try sut.append(TestElement(id: 1))
        try sut.append(TestElement(id: 2))
    ...
    func testAppend_withDateProperty_shouldEncodeAsSecondsSince1970() throws {
        // -- Arrange --
        let sut = try CrashSafeBatchBuffer<TestElementWithDate>(dataCapacity: 1_024 * 1_024, itemsCapacity: 100)
    ...
    func testAppend_whenBufferFull_shouldThrowBufferFull() throws {
        // -- Arrange --
        let dataCapacity = 100
        let sut = try CrashSafeBatchBuffer<TestElementWithSize>(dataCapacity: dataCapacity, itemsCapacity: 10)
        
        let elementSize = dataCapacity + 1
    ...
    func testAppend_whenItemsCapacityReached_shouldThrowBufferFull() throws {
        // -- Arrange --
        let itemsCapacity = 3
        let sut = try CrashSafeBatchBuffer<TestElement>(dataCapacity: 1_024 * 1_024, itemsCapacity: itemsCapacity)
