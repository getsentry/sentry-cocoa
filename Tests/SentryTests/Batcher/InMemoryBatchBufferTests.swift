...
final class InMemoryBatchBufferTests: XCTestCase {
    ...
    func testCount_withNoElements_shouldReturnZero() {
        // -- Act --
        let sut = InMemoryBatchBuffer<TestElement>(dataCapacity: 1_024 * 1_024, itemsCapacity: 100)
    ...
    func testCount_withSingleElement_shouldReturnOne() throws {
        // -- Arrange --
        var sut = InMemoryBatchBuffer<TestElement>(dataCapacity: 1_024 * 1_024, itemsCapacity: 100)
    ...
    func testAppend_withDateProperty_shouldEncodeAsSecondsSince1970() throws {
        // -- Arrange --
        var sut = InMemoryBatchBuffer<TestElementWithDate>(dataCapacity: 1_024 * 1_024, itemsCapacity: 100)
