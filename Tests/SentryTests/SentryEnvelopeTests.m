...
- (void)testSentryEnvelopeFromEvent
{
    ...
    NSData *json = [NSJSONSerialization dataWithJSONObject:[event serialize] options:0 error:nil];
...
- (void)testSentryEnvelopeWithExplicitInitMessages
{
    ...
    SentryEnvelopeItemHeader *itemHeader =
        [[SentryEnvelopeItemHeader alloc] initWithType:@"attachment" length:data.length];
