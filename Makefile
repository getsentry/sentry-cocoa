...
session-replay-camera-test-xcode:
	xcodegen --spec Samples/SessionReplay-CameraTest.yml --project Samples/XcodeGen --project-root Samples/SessionReplay-CameraTest
