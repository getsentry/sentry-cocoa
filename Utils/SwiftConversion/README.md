...
To generate the diagram locally, install Ruby and Graphviz, then run from the repository root:

```sh
make generate-swift-conversion-diagram
```

The JSON analysis, DOT graph, and SVG diagram are written to `Utils/SwiftConversion/`.
