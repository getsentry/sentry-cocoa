Pod::Spec.new do |s|
  ...
  s.preserve_path = "Sources/Sentry/include/module.modulemap"
  s.resource_bundles = { "Sentry" => "Sources/Resources/PrivacyInfo.xcprivacy" }
  s.source_files = "Sources/Sentry/**/*.{h,hpp,m,mm,c,cpp}",
