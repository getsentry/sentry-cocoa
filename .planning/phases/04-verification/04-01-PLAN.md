...
- Target key test classes: SentryCrashWrapperTests, SentryCrashTests, SentryCrashIntegrationTests, SentryCrashInstallationReporterTests
...
SentryCrashInstallationReporterTests
```
...
- Do NOT modify production code - bridge wiring is complete from Phase 3
  ...
  <verify>
  Run: `make test-ios ONLY_TESTING=SentryCrashWrapperTests,SentryCrashTests,SentryCrashIntegrationTests,SentryCrashInstallationReporterTests`

Expected output: `** TEST SUCCEEDED **` for all test classes
</verify>
<done>
All four SentryCrash test classes pass on iOS platform without production code changes.
</done>
</task>
...
1. **VERIFY-01:** SentryCrash test suite passes (SentryCrashWrapperTests, SentryCrashTests, SentryCrashIntegrationTests, SentryCrashInstallationReporterTests)
