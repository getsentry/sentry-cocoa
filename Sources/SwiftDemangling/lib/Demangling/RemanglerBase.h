...
namespace Demangle {
    ...
    public:
        void
        setNode(Node *node, bool treatAsIdentifier)
        {
        ...
        struct Hasher {
            size_t
            operator()(const SubstitutionEntry &entry) const
            {
    ...
    private:
        friend bool
        operator==(const SubstitutionEntry &lhs, const SubstitutionEntry &rhs)
        {
    ...
    public:
        RemanglerBuffer(NodeFactory &Factory)
            : Factory(Factory)
        {
