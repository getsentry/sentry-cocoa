...
#    define SWIFT_BUG_REPORT_MESSAGE_BASE                                                          \
        "submit a bug report (" SWIFT_BUG_REPORT_URL ") and include the project"

#    define SWIFT_BUG_REPORT_MESSAGE "please " SWIFT_BUG_REPORT_MESSAGE_BASE
...
#        define SWIFT_SYMBOL_PREFIX_STRING SWIFT_STRINGIZE_EXPANDED(__USER_LABEL_PREFIX__)
#    else
