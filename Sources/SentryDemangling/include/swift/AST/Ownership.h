...
enum : unsigned {
    NumReferenceOwnershipBits = countBitsUsed(static_cast<unsigned>(ReferenceOwnership::Last_Kind))
};

static inline llvm::StringRef
keywordOf(ReferenceOwnership ownership)
{
    switch (ownership) {
...
static inline llvm::StringRef
manglingOf(ReferenceOwnership ownership)
{
    switch (ownership) {
    case ReferenceOwnership::Strong:
        break;
...
static inline bool
isLessStrongThan(ReferenceOwnership left, ReferenceOwnership right)
{
...
enum : unsigned {
    NumOptionalityBits
    = countBitsUsed(static_cast<unsigned>(ReferenceOwnershipOptionality::Last_Kind))
};
...
enum : unsigned {
    NumValueOwnershipBits = countBitsUsed(static_cast<unsigned>(ValueOwnership::Last_Kind))
};
