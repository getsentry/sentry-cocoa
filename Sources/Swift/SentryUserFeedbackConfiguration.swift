...
@objc public class SentryUserFeedbackConfiguration: NSObject {
     ...
     */
    @objc public var configureWidget: ((SentryUserFeedbackWidgetConfiguration) -> Void)?
     ...
     */
    @objc public var useShakeGesture: Bool = false
     ...
     * - note: Setting this to true does not disable the widget. In order to do so, you must set `SentryUserFeedbackWidgetConfiguration.autoInject` to `false` using the `SentryUserFeedbackConfiguration.configureWidget` config builder.
     */
    @objc public var showFormForScreenshots: Bool = false
    
    /**
     * Configuration settings specific to the managed UI form to gather user input.
     * - note: Default: `nil`
     */
    @objc public var configureForm: ((SentryUserFeedbackFormConfiguration) -> Void)?
     ...
     * - note: Default: `false`
     */
    @objc public var useSentryUser: Bool = false
     ...
     * - note: Default: `nil`
     */
    @objc public var onSubmitError: ((Error) -> Void)?
}
