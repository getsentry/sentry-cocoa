...
public struct SentryInternalAppStartApi {
    ...
    /// Hybrid SDKs initialize too late to receive all launch notifications, so the measurement
    /// leaves the app start duration at zero and the did-finish-launching timestamp at the
    /// reference date. Disabled by default.
    ...
    public var measurementWithSpans: [String: Any]? {
        ...
        // Hybrid SDKs miss the launch notifications, so didFinishLaunchingTimestamp is unavailable.
        return [
