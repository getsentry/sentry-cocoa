...
@_spi(Private) @objc public final class SentryEnvelopeHeader: NSObject {
    ...
    @objc public convenience init(withId eventId: SentryId?) {
        self.init(withId: nil, traceContext: nil)
    }
     ...
     */
    @objc public init(withId eventId: SentryId?, traceContext: TraceContext?) {
        //self.init(with: eventId, sdkInfo: SentrySdkInfo.global, traceContext: traceContext)
    }
