...
@objc public class SentryUserFeedbackThemeConfiguration: NSObject {
     ...
     */
    public var foreground: UIColor = UIColor { (traitCollection) -> UIColor in
     ...
     */
    public var background: UIColor = UIColor { (traitCollection) -> UIColor in
     ...
     */
    public var successColor: UIColor = UIColor { (traitCollection) -> UIColor in
     ...
     */
    public var errorColor: UIColor = UIColor { (traitCollection) -> UIColor in
     ...
     * - note: Default: `nil (system default)`
     */
    public var outlineThicknessFocussed: CGFloat?
