#define SENTRY_ASYNC_SAFE_LOG_DEBUG
#define SENTRY_ASYNC_SAFE_LOG_INFO
#define SENTRY_ASYNC_SAFE_LOG_WARN
#define SENTRY_ASYNC_SAFE_LOG_ERROR
#define SENTRY_ASYNC_SAFE_LOG_FATAL
...
({                                                                                             \
    ...
    if (__log_mr != MACH_MSG_SUCCESS) {                                                        \
        SENTRY_ASYNC_SAFE_LOG_ERROR("%s failed with mach_msg return code: %d, description: %s",      \
