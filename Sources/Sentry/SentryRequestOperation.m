        ...
        self.task = [session
            dataTaskWithRequest:self.request
              completionHandler:^(NSData *_Nullable data, NSURLResponse *_Nullable response, NSError *_Nullable error) {
                  ...
                  [SentryLog logWithMessage:[NSString stringWithFormat:@"Request status: %ld", (long)statusCode]
                  ...
                  if (nil != error) {
                      [SentryLog logWithMessage:[NSString stringWithFormat:@"Request failed: %@", error]
