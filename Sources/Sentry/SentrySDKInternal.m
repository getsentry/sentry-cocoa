...
{
    return [SentrySDK captureError:error withScope:SentrySDKInternal.currentHub.scope];
}
...
{
    return [SentrySDK captureException:exception withScope:SentrySDKInternal.currentHub.scope];
}
...
+ (SentryId *)captureCrashOnException:(NSException *)exception
{
    ...
    return [SentrySDK captureException:wrappedException
...
{
    return [SentrySDK captureMessage:message withScope:SentrySDKInternal.currentHub.scope];
}
