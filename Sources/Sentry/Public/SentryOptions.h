 ...
 *
 * When enabled, the SDK creates a new transaction when none is bound to the scope for every
 * auto-instrumented span generated by the network, file IO,  core data, and user interaction
 * tracing. Enabling this feature disables `enableUserInteractionTracing`.
 *
 * @discussion Be aware that this will significantly impact your transaction quota as, most likely,
 * the SDK will send numerous more transactions.
 *
 * @note The default is @c NO.
 * @note Performance Monitoring and `enableAutoPerformanceTracing` must be enabled for this flag to
 * take effect. See: https://docs.sentry.io/platforms/apple/performance/
 */
@property (nonatomic) BOOL enableSendAllAutoPerformanceSpans;
