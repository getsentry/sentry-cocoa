...
/**
 * When enable, the SDK tracks UI performance automatically for UIViewControllers subclasses.
 * The default is <code>YES</code>.
 */
@property (nonatomic, assign) BOOL automaticallyTrackUIPerformance;
