...
@class SentryId, SentryThread, SentryException, SentryStacktrace, SentryUser, SentryDebugMeta, SentryContext, SentryBreadcrumb;
 ...
 */
@property(nonatomic, copy) SentryId *eventId;
