...
// This class is used to check if APPLICATION_EXTENSION_API_ONLY is set to YES for Sentry.
// If this is not set, the build will fail.
// For more information, see
// https://docs.sentry.io/platforms/apple/troubleshooting/#unknown-receiver-somereceiver-use-of-undeclared-identifier-someidentifier
