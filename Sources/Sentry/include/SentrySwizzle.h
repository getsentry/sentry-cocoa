 ...
 */
#define SentrySwizzleInstanceMethod(classToSwizzle, selector,                  \
 ...
 */
#define SentrySwizzleClassMethod(classToSwizzle, selector, SentrySWReturnType, \
...
#define _SentrySwizzleInstanceMethod(classToSwizzle, selector,                 \
    SentrySWReturnType, SentrySWArguments, SentrySWReplacement,                \
    SentrySwizzleMode, KEY)                                                    \
    [SentrySwizzle                                                             \
        swizzleInstanceMethod:selector                                         \
