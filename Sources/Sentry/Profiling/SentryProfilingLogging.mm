...
namespace profiling {
namespace {
SentryLevel sentryLevelFromLogLevel(LogLevel level) {
    switch (level) {
        case LogLevel::None:
...
void log(LogLevel level, const char *fmt, ...) {
    ...
    [SentryLog logWithMessage:[[NSString alloc] initWithFormat:fmtStr arguments:args] andLevel:sentryLevelFromLogLevel(level)];
}
