...
{
    return kIntegrationOptionEnableAutoPerformanceTracking | kIntegrationOptionEnableUIViewControllerTracking
        | kIntegrationOptionIsTracingEnabled | kIntegrationOptionEnableSwizzling;
}
