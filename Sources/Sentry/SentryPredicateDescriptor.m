...
- (NSString *)expressionDescription:(NSExpression *)predicate
{
    ...
    case NSConditionalExpressionType:
            if (@available(macOS 10.11, *)) {
                ...
                //this is not supposed to happen, NSConditionalExpressionType was introduced in macOS 10.11
                //but we need this version check because cocoapod lint check is failing without it.
                return @"";
            }
    default:
