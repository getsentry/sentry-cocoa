// File copied from
// https://github.com/google/GoogleUtilities/blob/797005ad8a1f0614063933e2fa010a5d13cb09d0/GoogleUtilities/SwizzlerTestHelpers/GULSwizzlingCache.m
//
...
@implementation GULSwizzlingCache {
    ...
    /** A mapping from a Class and SEL (stored in a CFArray) to the original IMP that existed for
     * it.
     */
...
+ (instancetype)sharedInstance
{
    ...
    dispatch_once(&token, ^{ sharedInstance = [[GULSwizzlingCache alloc] init]; });
