...
- (void)finishInternal
{
    ...
    sentry_stopProfilerDueToFinishedTransaction(_hub, _dispatchQueue, transaction, _isProfiling,
        self.startTimestamp ?: [NSDate date], _startSystemTime
#    if SENTRY_HAS_UIKIT
        ,
        appStartMeasurement
#    endif // SENTRY_HAS_UIKIT
...
- (BOOL)finishTracer:(SentrySpanStatus)unfinishedSpansFinishStatus shouldCleanUp:(BOOL)shouldCleanUp
{
    ...
    NSDate *safeStartTimestamp = self.startTimestamp ?: [NSDate date];
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wnullable-to-nonnull-conversion"
    NSTimeInterval transactionDuration = [self.timestamp timeIntervalSinceDate:safeStartTimestamp];
