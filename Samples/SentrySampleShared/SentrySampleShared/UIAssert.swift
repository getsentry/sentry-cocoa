...
public class UIAssert {
    public static let shared = UIAssert()
    private let view = AssertView()
    private var isFailed = false
    public var targetView: AssertView?
    ...
    public static func fail(_ errorMessage: String? = nil) {
        shared.assert(success: false, errorMessage: errorMessage)
    }

    public static func checkForViewControllerLifeCycle(_ transaction: Span, viewController: String, stepsToCheck: [String]? = nil, checkExcess: Bool = false) {
