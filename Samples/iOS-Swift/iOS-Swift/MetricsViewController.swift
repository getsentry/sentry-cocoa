...
class MetricsViewController: UIViewController {
    ...
    @IBAction func addCountAction(_ sender: UIButton) {
        ...
        SentrySDK.metrics.count(
            key: "ios.app.action.string_array",
            value: 1,
            unit: "action",
            attributes: [
        ...
        SentrySDK.metrics.count(
            key: "ios.app.action.boolean_array",
            value: 1,
            unit: "action",
            attributes: [
        ...
        SentrySDK.metrics.count(
            key: "ios.app.action.integer_array",
            value: 1,
            unit: "action",
            attributes: [
        ...
        SentrySDK.metrics.count(
            key: "ios.app.action.double_array",
            value: 1,
            unit: "action",
            attributes: [
    ...
    @IBAction func addDistributionAction(_ sender: UIButton) {
        ...
        SentrySDK.metrics.distribution(
            key: "ios.network.response_time.string",
            value: responseTime,
            unit: "millisecond",
            attributes: [
                "endpoint": endpoint,
        ...
        let cached = false
        SentrySDK.metrics.distribution(
            key: "ios.network.response_time.boolean",
            value: responseTime,
            unit: "millisecond",
            attributes: [
                "cached": cached,
        ...
        let statusCode = 200
        SentrySDK.metrics.distribution(
            key: "ios.network.response_time.integer",
            value: responseTime,
            unit: "millisecond",
            attributes: [
        ...
        SentrySDK.metrics.distribution(
            key: "ios.network.response_time.double",
            value: responseTime,
            unit: "millisecond",
            attributes: [
        ...
        SentrySDK.metrics.distribution(
            key: "ios.network.response_time.string_array",
            value: responseTime,
            unit: "millisecond",
            attributes: [
                "endpoints": endpoints,
        ...
        SentrySDK.metrics.distribution(
            key: "ios.network.response_time.boolean_array",
            value: responseTime,
            unit: "millisecond",
            attributes: [
        ...
        SentrySDK.metrics.distribution(
            key: "ios.network.response_time.integer_array",
            value: responseTime,
            unit: "millisecond",
            attributes: [
        ...
        SentrySDK.metrics.distribution(
            key: "ios.network.response_time.double_array",
            value: responseTime,
            unit: "millisecond",
            attributes: [
    ...
    @IBAction func addGaugeAction(_ sender: UIButton) {
        ...
        SentrySDK.metrics.gauge(
            key: "ios.memory.usage.string_array",
            value: memoryUsage,
            unit: "megabyte",
            attributes: [
                "processes": processes,
        ...
        SentrySDK.metrics.gauge(
            key: "ios.memory.usage.boolean_array",
            value: memoryUsage,
            unit: "megabyte",
            attributes: [
        ...
        SentrySDK.metrics.gauge(
            key: "ios.memory.usage.integer_array",
            value: memoryUsage,
            unit: "megabyte",
            attributes: [
        ...
        SentrySDK.metrics.gauge(
            key: "ios.memory.usage.double_array",
            value: memoryUsage,
            unit: "megabyte",
            attributes: [
