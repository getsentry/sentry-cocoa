...
class TraceTestViewController: UIViewController {
    ...
    func assertTransaction(span: Span) {
        ...
        UIAssert.checkForViewControllerLifeCycle(span, expectingSpans: lifeCycleSteps.count + 6, viewController: "TraceTestViewController", stepsToCheck: lifeCycleSteps)
    }
}
