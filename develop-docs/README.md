...
- [Language Trends Report](https://github.com/getsentry/sentry-cocoa/actions/workflows/language-trends.yml): interactive chart of the repository's language breakdown over time, generated on every merge to main. To view the report, click the latest successful run, scroll to the "Artifacts" section at the bottom, download the `language-trends` zip, extract it, and open `language-trends.html` in your browser.
