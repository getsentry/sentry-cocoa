...
- Swift unit and integration tests are in [`Tests/SentryTests/HybridSDK/`](../Tests/SentryTests/HybridSDK/). `SentryInternalApiTests.swift` preserves the legacy facade's behavioral tests through the structured API.
