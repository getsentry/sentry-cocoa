...
- Move `enableFileManagerSwizzling` from experimental options to top-level options (#4880). This option is still disabled by default and will be enabled in a future major release.
- Move `enableDataSwizzling` from experimental options to top-level options. This option remains enabled by default.
